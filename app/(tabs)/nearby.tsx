...
const CATEGORIES = ['가게·업체', '구인구직', '과외·클래스', '농수산물', '중고차'];
...
export default function NearbyScreen() {
  ...
  const [activeCategory, setActiveCategory] = useState('가게·업체');
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>주변 가게 정보가 없어요</Text>
            <Text style={styles.emptySubText}>내 근처 가게를 찾아보세요</Text>
          </View>
        }
